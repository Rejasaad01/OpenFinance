<template>
  <div class="ml-0 md:ml-72 flex-1 flex flex-col min-h-screen bg-surface relative">
    <!-- Header Section -->
    <header class="px-8 lg:px-12 py-10 bg-surface-container-lowest border-b border-outline-variant/10">
      <div class="max-w-[1600px] mx-auto flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8">
        <div>
          <div class="flex items-center gap-3 mb-2">
            <div class="w-8 h-8 rounded-lg bg-primary flex items-center justify-center text-on-primary shadow-sm">
              <span class="material-symbols-outlined text-[18px]">account_balance_wallet</span>
            </div>
            <h2 class="font-headline text-3xl font-extrabold text-on-surface tracking-tight">Financial Hub</h2>
          </div>
    ...
    <!-- Main Content Area -->
    <main class="flex-1 px-8 lg:px-12 py-10 max-w-[1600px] mx-auto w-full overflow-x-hidden">
